...
class FacebookAuthController {
    static async signInWithFacebook() {
        try {
            ...
            let accessToken;
            if (Platform.OS === "ios") {
                const authTokenResult = await AuthenticationToken.getAuthenticationTokenIOS();
            ...
            const userData = await FacebookAuthController.fetchFacebookUserData(accessToken);
